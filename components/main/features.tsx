        ...
        <div className="lg:max-w-8xl mx-auto">
            <div className="w-11/12 mx-auto">
                <div className="flex flex-col items-center">
                    <p className="text-orange-500 text-base mb-4">FITUR KAMI</p>
                    <h1 className="text-2xl font-bold text-center text-sky-900 mb-5 lg:text-4xl lg:w-7/12">Kami yakin kami bisa menghemat
