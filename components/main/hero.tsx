        ...
        <div>
            <div className="bg-sky-100">
                <div className="lg:max-w-8xl mx-auto">
                    <div className="w-11/12 mx-auto pt-6 pb-6 lg:flex lg:flex-row lg:items-center lg:justify-between">
                        <div className="lg:w-1/2">
                            <h1 className="text-black text-3xl font-bold text-sky-900 lg:text-5xl lg:leading-relaxed">Donasi Anda sekecil apapun, akan sangat berarti bagi mereka</h1>
                        ...
                        <div className="flex justify-center">
                            <Image src={img2} alt={""} width={320} height={400} className="mt-12 lg:w-[582px] lg:h-[468px]"
                            ></Image>
                        </div>
                    </div>
                </div>
