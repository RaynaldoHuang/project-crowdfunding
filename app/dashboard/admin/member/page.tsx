            ...
            <div className='mt-20 mx-5 bg-white px-5 py-10 mb-10 rounded-xl'>
                ...
                <table className='table-auto w-full'>
                    <thead className='text-left border-b-2'>
                        <tr className=''>
                            <th className='font-normal text-xs text-slate-500 pb-2'>Nama Depan</th>
                            <th className='font-normal text-xs text-slate-500 pb-2'>Nama Belakang</th>
                    ...
                    <tbody>
                        {
                            members.map((member: any) => (
                                <tr key={member.id} className='border-b'>
                                    ...
                                    <td className={clsx('text-xs', member.gender == 'MALE' ? 'text-sky-600' : 'text-red-600')}>
