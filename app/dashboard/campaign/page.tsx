            ...
            <div className="lg:w-full px-5 lg:mt-20 mt-24 mb-24">
                <div className='mb-5 bg-white py-5 rounded-xl px-3 lg:flex lg:justify-between lg:items-center'>
                    ...
                    <div className="relative">
                        ...
                        <input type="text" id="first_name" className="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:border-sky-600 block w-[326px] p-2.5 pl-12" placeholder="Pencarian..." />
                    </div>
                </div>
                    ...
                    {dynamicArr.map((c: any, idx) => (
                        <div key={idx} className="bg-white px-3 py-3 rounded-2xl">
                            ...
                            <div className="pb-0 pt-2 flex-col items-start">
                                ...
                                <Link href={`/dashboard/campaign/${c.id}`}><button className='text-white px-8 mt-4 py-2 bg-sky-600 rounded-xl text-sm text-center w-full'>Lihat Detail</button></Link>
                            </div>
                        </div>
                    ))}
                </div>
